...
[Semantic Weight·이론 기반](docs/research/HSWM_SEMANTIC_WEIGHT_THEORETICAL_FOUNDATIONS_2026-09-14.md) · [심층 연구·실현 경로](docs/research/HSWM_DEEP_RESEARCH_AND_REALIZATION_2026-09-22.md) · [Jev 연구·그래프 엔지니어링](docs/research/HSWM_JEV_GRAPH_ENGINEERING_2026-09-22.md) · [지식 지도·개발 현황](docs/operations/HSWM_KNOWLEDGE_MAP_2026-09-13.md) · [연구 도구·표준 조사](docs/research/HSWM_SCIENTIFIC_RESEARCH_TOOLING_2026-09-13.md) · [그래프 구조](#graph-model) · [빠른 실행](#quick-start) · [개발 실사용](#development) · [근거와 판정](#evidence) · [전체 문서](INDEX.md)
...
이를 [Lean4 정의와 하이퍼그래프 표현 정리](docs/research/HSWM_SEMANTIC_WEIGHT_DEFINITION_AND_HYPERGRAPH_2026-09-14.md)로
구체화했습니다. 다자 관계를 단순한 쌍별 연결로 투영할 때의 손실과,
역할을 보존하는 이항 incidence 표현의 가능성을 구분합니다.
...
[구성적 증명](docs/research/HSWM_SEMANTIC_WEIGHT_CONSTRUCTIVE_PROOF_2026-09-14.md)은 그 조건을
유한 관계 학습기와 Lean의 실행·학습 보존 정리에 연결합니다. 완전한 HSWM이나 실제 LLM의 효능 증명이
아니며, 필요한 관측이 없을 때의 식별 불가능성도 함께 기록합니다.

[LLM 의미 엔진 연구](docs/research/HSWM_LLM_SEMANTIC_ENGINE_RESEARCH_2026-09-14.md)는
LLM의 사전학습 의미를 활용해 관계를 실행하고 경험으로 수정하는 이론 경로를 다룹니다.
...
USL 후속 검토·Reluvator 연결·HSWM 자체 개발은
[오늘 작업 온톨로지](docs/operations/HSWM_DEVELOPMENT_DAY_KG_2026-09-08.md)에 별도 스냅샷으로 기록합니다.
사용자 원문, 과거 결함의 수정 상태, 실제 실행 보고와 미완료 항목을 출처로 연결합니다.
