...
SYMPOSIUM 안의 추적 정본은 `HSWM/prom_search_hswm/`이고, 별도 `/Users/lagyeongjun/CD/HSWM` 저장소에는 동시에 진행 중인 untracked 실험이 확인되어 이번 write-set에서 제외했다. 라이브 LakatoTree는 로컬 `:55170` relay가 가리키는 서버이며 boot/disk SHA가 clean `PI/lakatotree@71915a52ee934e20943bfa33ad934711f0eceb4e`와 일치했다.
