...
> **코드**: `GIT/HSWM/r1_t1_retry.py` + `r1_predicate_alias.py`  
> **prereg**: `GIT/HSWM/PREREG_R1_T1_RETRY_2026-07-22.json` (receipt `f52d881b…`)  
> **evidence**: `GIT/HSWM/EVIDENCE_R1_T1_RETRY_2026-07-22.json` (sha `154e906a…`)  
