...
Usage:  .venv/bin/python _research/bookscale/c1_prelude_bookscale.py [--limit N] [--parallel 8] [--judge/--no-judge]
"""
...
def _discover_repository_root(anchor: str | Path = __file__) -> Path:
    """Find the checkout root that owns the locked data and legacy modules."""
