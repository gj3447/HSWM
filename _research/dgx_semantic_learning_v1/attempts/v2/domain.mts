...
export const protocol = {
  schema_version: 'hswm-dgx-semantic-learning/v2', date: '2026-09-20',
  ...
  trials: 32, maximum_model_calls: 256, maximum_wall_seconds: 2400, trial_concurrency: 1,
  amendment: 'v1 retained: FP8 serving CUTLASS failure and non-hardlink-preserving copy invalidated comparisons. v2 uses sequential trials and archive-preserving copies; labels, splits and scoring unchanged. Backend cause is not established by serialization.',
