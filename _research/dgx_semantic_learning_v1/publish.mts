...
const expected = '7f5360a43706297eb087b7d22c9fc2f10db9c9603e91ffe20b3ba5ae6482f66d';
const reportPath = 'docs/research/artifacts/hswm_dgx_frontier_2026-09-20/live-publication.v1.json';
...
const main = Effect.gen(function* () {
  ...
  const report = { schema_version: 'hswm-research-live-publication/v1', attempt: 1,
    ...
    query_adapter_source: '_research/dgx_semantic_learning_v1/publish.mts', query_adapter_sha256: sha(adapter),
