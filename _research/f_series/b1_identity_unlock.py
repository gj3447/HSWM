...
CACHE = REPO_ROOT / ".ab_p5_cache" / "h3_b3"
...
PREREG = REPO_ROOT / "PREREG_B1_IDENTITY_UNLOCK_2026-07-22.json"
EVIDENCE = REPO_ROOT / "EVIDENCE_B1_IDENTITY_UNLOCK_2026-07-22.json"
RECEIPTS = REPO_ROOT / "RECEIPTS_B1_IDENTITY_UNLOCK_2026-07-22.json"
...
def preregistration_guard() -> dict:
    ...
    for module in FROZEN_MODULES:
        ...
        actual = _sha256_file(source_path(module))
        if expected != actual:
            raise RuntimeError(
