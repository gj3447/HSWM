...
Usage:
  .venv/bin/python -m _research.f_series.f2_delta_w_credit --smoke
  .venv/bin/python -m _research.f_series.f2_delta_w_credit --universes-dir _research/f2_sealed_universes
"""
...
DEFAULT_UNIVERSES_DIR = REPO_ROOT / "_research" / "r3_replay" / "universes"
CACHE_DIR = REPO_ROOT / ".f2_cache"
