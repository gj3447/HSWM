...
Usage:
  .venv/bin/python -m _research.f_series.f3_agent_ab_transfer_r2 --smoke
  .venv/bin/python -m _research.f_series.f3_agent_ab_transfer_r2 --universes-dir _research/f2_sealed_universes
"""
