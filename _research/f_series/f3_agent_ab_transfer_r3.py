...
Usage:
  .venv/bin/python -m _research.f_series.f3_agent_ab_transfer_r3 --smoke
  .venv/bin/python -m _research.f_series.f3_agent_ab_transfer_r3 --universes-dir _research/f2_sealed_universes
"""
...
from . import f3_agent_ab_transfer as f3r1
from . import f3_agent_ab_transfer_r2 as f3r2
    ...
    receipt = {
        ...
        "harness_module_sha256": {
            ...
            "f3_agent_ab_transfer.py": hashlib.sha256(
                source_path("f3_agent_ab_transfer.py").read_bytes()).hexdigest(),
            "f3_agent_ab_transfer_r2.py": hashlib.sha256(
                source_path("f3_agent_ab_transfer_r2.py").read_bytes()).hexdigest(),
            "p1v3_multi_environment.py": hashlib.sha256(
                source_path("p1v3_multi_environment.py").read_bytes()).hexdigest(),
        },
