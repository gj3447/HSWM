...
Usage:
  .venv/bin/python -m _research.f_series.f4_topology_learning --smoke
  .venv/bin/python -m _research.f_series.f4_topology_learning --universes-dir _research/f2_sealed_universes
"""
