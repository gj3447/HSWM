...
Usage:
  .venv/bin/python -m _research.f_series.f4_topology_learning_r2 --smoke
  .venv/bin/python -m _research.f_series.f4_topology_learning_r2 --universes-dir _research/f2_sealed_universes
"""
...
from . import f4_topology_learning as f4r1
    ...
    receipt = {
        ...
        "harness_module_sha256": {
            ...
            "f4_topology_learning.py": hashlib.sha256(
                source_path("f4_topology_learning.py").read_bytes()).hexdigest(),
