...
Usage:
  .venv/bin/python -m _research.f_series.f5_consolidation --smoke
  .venv/bin/python -m _research.f_series.f5_consolidation --universes-dir _research/f2_sealed_universes
"""
