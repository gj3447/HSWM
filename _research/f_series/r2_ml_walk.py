...
PREREG = REPO_ROOT / "PREREG_R2_ML_WALK_2026-07-22.json"
EVIDENCE = REPO_ROOT / "EVIDENCE_R2_ML_WALK_2026-07-22.json"
MATERIAL = {
    ds: {phase: REPO_ROOT / ".ab_p5_cache" / "r2_material" / f"{ds}_{phase}.json"
...
def preregistration_guard() -> dict:
    ...
    for module in FROZEN_MODULES:
        if locked["module_sha256"].get(module) != _sha(source_path(module)):
