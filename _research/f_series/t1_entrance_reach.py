...
PREREG = REPO_ROOT / "PREREG_T1_ENTRANCE_REACH_2026-07-22.json"
EVIDENCE = REPO_ROOT / "EVIDENCE_T1_ENTRANCE_REACH_2026-07-22.json"
...
def preregistration_guard() -> dict:
    ...
    for module in FROZEN_MODULES:
        if locked["module_sha256"].get(module) != _sha256_file(source_path(module)):
