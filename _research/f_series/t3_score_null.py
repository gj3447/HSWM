...
PREREG = REPO_ROOT / "PREREG_T3_SCORE_NULL_2026-07-23.json"
EVIDENCE = REPO_ROOT / "EVIDENCE_T3_SCORE_NULL_2026-07-23.json"
FROZEN_MODULES = (
...
def preregistration_guard() -> dict:
    ...
    mat_dir = REPO_ROOT / ".ab_p5_cache" / "r2_material"
