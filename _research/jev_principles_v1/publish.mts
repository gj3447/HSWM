/** Publish only the reviewed 2026-09-21 bundle through the existing guarded adapter. */
...
const path = 'ontology/development/HSWM_JEV_PRINCIPLES_2026-09-21.v1.json';
const expected = '18200d2fbfb9803a3ab9d50461ef5d72dfb0643f49f0d44bdc57544ebb242da7';
const reportPath = 'docs/research/artifacts/hswm_jev_principles_2026-09-21/live-publication.v1.json';
...
const main = Effect.gen(function* () {
  ...
  const report = { schema_version: 'hswm-research-live-publication/v1', attempt: 1,
    ...
    query_adapter_source: '_research/jev_principles_v1/publish.mts', query_adapter_sha256: sha(adapter),
