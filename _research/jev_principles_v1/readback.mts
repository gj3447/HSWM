...
const raw = await readFile('ontology/development/HSWM_JEV_PRINCIPLES_2026-09-21.v1.json');
...
try {
  ...
  await writeFile('docs/research/artifacts/hswm_jev_principles_2026-09-21/post-commit-readback.v1.json', JSON.stringify(report, null, 2) + '\n', { flag: 'wx' });
