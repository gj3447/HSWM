...
실행 (venv 분리 — 의존성 충돌 격리):
  .venv_coref/bin/python -m _research.material_extraction.r2_material_extract --phase coref
  .venv_refined/bin/python -m _research.material_extraction.r2_material_extract --phase link
"""
