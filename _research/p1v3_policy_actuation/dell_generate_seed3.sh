...
project_root=/data/kjra/PROJECT/HSWM_P1V3_20260724_FROZEN_DATA
final_root="$project_root/phantomwiki_seed3/sparse_t200_fk1"
staging_root="$project_root/.staging-phantomwiki-seed3-sparse-t200-fk1"
...
mkdir -p "$project_root/phantomwiki_seed3"
...
"$env_root/bin/python" - "$final_root" "$project_root/generation_receipt_seed3.json" <<'PY'
from __future__ import annotations
...
receipt = {
    "schema_version": "hswm-p1v3-phantom-generation-receipt/v1",
    "generator": {
    ...
    "universe": "sparse_t200_fk1_seed3",
    "dataset_files": {
