...
code_root=/data/kjra/PROJECT/HSWM_P1V4R2_20260724_CODE_0ea9453
data_root=/data/kjra/PROJECT/HSWM_P1V4R2_20260724_FROZEN_DATA
universe_root="$data_root/phantomwiki_seed5/sparse_t200_fk1_q200"
generation_receipt="$data_root/generation_receipt_seed5_r2.json"
public_output="$data_root/p1v4_policy_public_manifest_seed5_r2.json"
development_output="$data_root/sealed/p1v4_policy_seed5_development_r2.json"
heldout_output="$data_root/sealed/p1v4_policy_seed5_heldout_r2.json"
separation_output="$data_root/p1v4_policy_sidecar_separation_seed5_r2.json"
...
separation = {
    ...
    "eligibility": {
        "candidate_count_at_least_required": True,
        "required_count": 10,
        "selection_used_gold": False,
        "prior_seed4_abort_candidate_count": 3,
    },
    "public": {
