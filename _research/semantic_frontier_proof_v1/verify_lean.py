...
DEPENDENCIES = ["HSWMSemanticWeightDefinition", "HSWMHypergraphRepresentation", "HSWMLocalEnsembleGain", "HSWMOutcomeLearningGain"]
NEW_MODULES = ["HSWMConstructiveRelationSynthesis", "HSWMCorrelatedReliability", "HSWMNoisyFeedback", "HSWMRecursiveLearningComposition", "HSWMGeneratedLearningBridge"]
...
def main():
    ...
    records = []
    dependencies = []
    with tempfile.TemporaryDirectory(prefix="hswm-semantic-frontier-") as directory:
    ...
    result = {
        "schema_version": "hswm-semantic-frontier-lean-verification/v1",
        ...
        "command": "python3 _research/semantic_frontier_proof_v1/verify_lean.py",
        "new_dependencies_installed": False,
        "claim_ceiling": "FINITE_GRAMMAR_SYNTHESIS_CORRELATED_RELIABILITY_NOISY_FEEDBACK_AND_RECURSIVE_LEARNING",
