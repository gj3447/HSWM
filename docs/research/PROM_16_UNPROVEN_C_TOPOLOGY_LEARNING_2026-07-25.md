...
- '학습' 포기 + '검색' 채택: MASS/AFlow식으로 topology를 offline 검색 공간으로 취급하고 best-of-N 정적 토폴로지를 봉인 — claim ③은 반증 처리하되 실용 효과는 확보, HSWM_LOCAL_RECORD에는 'rewiring은 학습 아닌 선택'으로 기록
