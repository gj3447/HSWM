...
Usage:
  python3 f3v2_dev_smoke.py                          # offline dry-run (legacy)
  python3 f3v2_dev_smoke.py --gated                  # 10 contexts
  python3 f3v2_dev_smoke.py --manifest <sealed.json> # sealed rehearsal (scripted)
  python3 f3v2_dev_smoke.py --manifest <sealed.json> --live   # SEALED RUN
  python3 f3v2_dev_smoke.py --manifest <dev.json> --live --dev # dev-weight live
"""
