...
def _source_a() -> dict[str, object]:
    ...
    return {
        ...
        "plan_descriptor_contract": {"media_type": preflight.PLAN_MEDIA_TYPE, "producer_schema": randomization.SCHEMA_VERSION, "independent_schema": independent_randomization.SCHEMA_VERSION, "encoding": preflight.PLAN_ENCODING, "codec_contract_version": preflight.PLAN_ENCODING, "codec_kat_media_type": preflight.PLAN_JSON_KAT_MEDIA_TYPE, "codec_kat_sha256": preflight.PLAN_JSON_KAT_SHA256, "codec_kat_byte_length": preflight.PLAN_JSON_KAT_BYTE_LENGTH, "blob_transport": preflight.PLAN_BLOB_TRANSPORT, "max_blob_bytes": preflight.PLAN_MAX_BLOB_BYTES, "cross_language_status": preflight.PLAN_CROSS_LANGUAGE_STATUS},
