...
CLOSURE = ROOT / "ontology/identity/hswm_core/HSWM_CLOSURE_PLAN_ONTOLOGY.v4.json"
...
@pytest.mark.parametrize("path", (CLOSURE, CLOSURE_V3, CLOSURE_V2, CLOSURE_V1, ADAPTIVE, CAUSAL, GRAPH_LOOP, EFFECT_FP))
